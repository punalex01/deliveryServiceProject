...
/*int main()
{
    ...
    ifstream infile("/Users/alexpun/Desktop/cs32/project4/project4/project4/mapdata.txt");
    string s;
    int i = 0;
    while (getline(infile, s))
    {
        if (test.find(s) == nullptr)
            test.associate(s, i);
        i++;
    }
    test.printAll();
    ...
    StreetMap test;
    test.load("/Users/alexpun/Desktop/cs32/project4/project4/project4/mapdata.txt");
    
    list<StreetSegment> ok;
    double nice;
    GeoCoord start("34.0544590", "-118.4801137");
    GeoCoord end("34.0524847", "-118.4788976");
    PointToPointRouter testRoute(&test);
    testRoute.generatePointToPointRoute(start, end, ok, nice);
    cout << nice;
}*/
